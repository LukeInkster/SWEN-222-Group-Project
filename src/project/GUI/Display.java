...
public class Display {
	...
	Image tile = GameSerialize.loadImage(new File("assets//Tile.png"));
	Image door = GameSerialize.loadImage(new File("assets//Door.png"));
	Image doorIso = GameSerialize.loadImage(new File("assets//DoorIso.png"));
